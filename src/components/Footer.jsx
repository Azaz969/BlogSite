...
const Footer = () => {
  return (
    <div className="bg-black me-0 mt-2 px-10 py-28">
      <div className="md:flex justify-between flex-row align-middle ;">
        <div className=" px-4">
          <h3 className=" text-slate-50 text-xl font-bold md:mt-4">Top Products</h3>
          <div className=" grid grid-rows-1 pl-4  text-slate-500">
        ...
        <div className=" px-4 md:mt-0 mt-5">
          <h3 className="text-slate-50 text-xl font-bold mt-4">Quick Links</h3>
          <div className=" grid grid-rows-1 pl-4 text-slate-500">
        ...
        <div className=" px-4 md:mt-0 mt-5">
          <h3 className="text-slate-50 text-xl font-bold mt-4">Features</h3>
          <div className=" grid grid-rows-1 pl-4 text-slate-500">
            <Link className=" my-1">Jobs</Link>
            <Link className=" my-1">Brand Assets</Link>
            <Link className=" my-1">Investor Relations</Link>
        ...
        <div className=" px-4 md:mt-0 pl-4 mt-5">
          <h3 className="text-slate-50 text-xl font-bold mt-4">Resources</h3>
          <div className=" grid grid-rows-1 pl-4 text-slate-500">
